...
class CfgSlots {
	class Slot_Filament_1
	{
		...
		ghostIcon = "set:Citadel_PC image:Filament";
	};
...
class CfgNonAIVehicles
{
	...
	class ProxyFilament_1: ProxyAttachment
	{
		...
		model = "Citadel_PC\Models\3D_Printer\Filament\Proxies\Filament_1.p3d";
	};
	class ProxyFilament_2: ProxyAttachment
	{
		inventorySlot[] = {"Filament_2"};
		model = "Citadel_PC\Models\3D_Printer\Filament\Proxies\Filament_2.p3d";
	};
	class ProxyFilament_3: ProxyAttachment
	{
		inventorySlot[] = {"Filament_3"};
		model = "Citadel_PC\Models\3D_Printer\Filament\Proxies\Filament_3.p3d";
	};
	class ProxyFilament_4: ProxyAttachment
	{
		inventorySlot[] = {"Filament_4"};
		model = "Citadel_PC\Models\3D_Printer\Filament\Proxies\Filament_4.p3d";
	};
	class ProxyFilament_5: ProxyAttachment
	{
		inventorySlot[] = {"Filament_5"};
		model = "Citadel_PC\Models\3D_Printer\Filament\Proxies\Filament_5.p3d";
	};
	class ProxyFilament_6: ProxyAttachment
	{
		inventorySlot[] = {"Filament_6"};
		model = "Citadel_PC\Models\3D_Printer\Filament\Proxies\Filament_6.p3d";
	};
	class ProxyFilament_7: ProxyAttachment
	{
		inventorySlot[] = {"Filament_7"};
		model = "Citadel_PC\Models\3D_Printer\Filament\Proxies\Filament_7.p3d";
	};
	class ProxyFilament_8: ProxyAttachment
	{
		inventorySlot[] = {"Filament_8"};
		model = "Citadel_PC\Models\3D_Printer\Filament\Proxies\Filament_8.p3d";
	};
};