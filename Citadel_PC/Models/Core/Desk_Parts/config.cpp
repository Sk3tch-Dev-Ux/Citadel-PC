...
class CfgVehicles
{
	...
	class Citadel_Desk_Build: Inventory_Base
	{
		scope = 2;
		displayName = "Desk Hologram";
		model = "Citadel_PC\Models\Core\Desk_Parts\Desk.p3d";
	...
	class Citadel_PC_Case: Inventory_Base
	{
		scope = 2;
		model = "Citadel_PC\Models\Core\Desk_Parts\PC_Case.p3d";
	...
	class Citadel_PC_Desk_Top_1: Inventory_Base
	{
		scope = 2;
		model = "Citadel_PC\Models\Core\Desk_Parts\Desk_Top_1.p3d";
	...
	class Citadel_PC_Desk_Top_2: Inventory_Base
	{
		scope = 2;
		model = "Citadel_PC\Models\Core\Desk_Parts\Desk_Top_2.p3d";
	...
	class Citadel_PC_Leg_1: Inventory_Base
	{
		scope = 2;
		model = "Citadel_PC\Models\Core\Desk_Parts\Leg_1.p3d";
	...
	class Citadel_PC_Leg_2: Inventory_Base
	{
		scope = 2;
		model = "Citadel_PC\Models\Core\Desk_Parts\Leg_2.p3d";
	...
	class Citadel_PC_Leg_3: Inventory_Base
	{
		scope = 2;
		model = "Citadel_PC\Models\Core\Desk_Parts\Leg_3.p3d";
...
class CfgNonAIVehicles
{
	...
	class ProxyPC_Case: ProxyAttachment
	{
		...
		model = "Citadel_PC\Models\Core\Desk_Parts\Proxies\PC_Case.p3d";
	};
	class ProxyDesk_Top_1: ProxyAttachment
	{
		inventorySlot[] = {"Slot_Desk_Top_1"};
		model = "Citadel_PC\Models\Core\Desk_Parts\Proxies\Desk_Top_1.p3d";
	};
	class ProxyDesk_Top_2: ProxyAttachment
	{
		inventorySlot[] = {"Slot_Desk_Top_2"};
		model = "Citadel_PC\Models\Core\Desk_Parts\Proxies\Desk_Top_2.p3d";
	};
	class ProxyLeg_1: ProxyAttachment
	{
		inventorySlot[] = {"Slot_Leg_1"};
		model = "Citadel_PC\Models\Core\Desk_Parts\Proxies\Leg_1.p3d";
	};
	class ProxyLeg_2: ProxyAttachment
	{
		inventorySlot[] = {"Slot_Leg_2"};
		model = "Citadel_PC\Models\Core\Desk_Parts\Proxies\Leg_2.p3d";
	};
	class ProxyLeg_3: ProxyAttachment
	{
		inventorySlot[] = {"Slot_Leg_3"};
		model = "Citadel_PC\Models\Core\Desk_Parts\Proxies\Leg_3.p3d";
	};
};