...
class CfgVehicles
{
	...
	class Citadel_Bitcoin: Inventory_Base
	{
		scope = 2;
		displayName = "Bitcoin";
		...
		model = "Citadel_PC\Models\Bitcoin\Crypto\Bitcoin\Citadel_Bitcoin.p3d";
		canBeSplit = 1;
		rotationFlags = 0;
	...
	class Citadel_XRP: Inventory_Base
	{
		scope = 2;
		model = "Citadel_PC\Models\Bitcoin\Crypto\XRP\Citadel_XRP.p3d";
		displayName = "XRP";
	...
	class Citadel_Ethereum: Inventory_Base
	{
		scope = 2;
		model = "Citadel_PC\Models\Bitcoin\Crypto\Ethereum\Citadel_Ethereum.p3d";
	...
	class Citadel_Solana: Inventory_Base
	{
		scope = 2;
		model = "Citadel_PC\Models\Bitcoin\Crypto\Solana\Citadel_Solana.p3d";
		displayName = "Solana";
	...
	class Citadel_Mining_Chassis_Base: Inventory_Base
	{
		scope = 0;
		model = "Citadel_PC\Models\Bitcoin\Mining_Chassis\Mining_Chassis.p3d";
	...
	class Citadel_Mining_Chassis: Citadel_Mining_Chassis_Base
	{
		scope = 2;
		displayName = "Mining Chassis";
		hiddenSelectionsTextures[]=
		{
			"Citadel_PC\Models\Bitcoin\Mining_Chassis\Textures\Body_co.paa",
			"Citadel_PC\Models\Bitcoin\Mining_Chassis\Textures\Parts_co.paa"
		};
	};
};
