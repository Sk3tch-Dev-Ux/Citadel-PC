class Unpack_Citadel_Desk_Box extends RecipeBase
{    
    override void Init()
    {
        m_Name = "Open Citadel Desk Box";  // Action Display Name
        m_IsInstaRecipe = false;                
        m_AnimationLength = 2;                    
        m_Specialty = 0;                        

        // Begin Crafting Recipe
        InsertIngredient(0, "Citadel_Desk_Box");  // The desk kit to be unpacked
        ...
        AddResult("Citadel_PC_Desk_Top_1");
        AddResult("Citadel_PC_Desk_Top_2");
        AddResult("Citadel_PC_Leg_1");
        AddResult("Citadel_PC_Leg_2");
        AddResult("Citadel_PC_Leg_3");
        AddResult("Citadel_PC_Case");
        AddResult("Citadel_Desk_Manual");
