class ActionDismantleCitadelPCDeskHologramCB : ActionContinuousBaseCB
{
...
class ActionDismantleCitadelPCDeskHologram: ActionContinuousBase
{
	void ActionDismantleCitadelPCDeskHologram()
	{
		m_CallbackClass = ActionDismantleCitadelPCDeskHologramCB;
	...
	override bool ActionCondition( PlayerBase player, ActionTarget target, ItemBase item )
	{
		...
		Citadel_Desk_Build wallholo = Citadel_Desk_Build.Cast( target.GetObject() );
	...
	{
		Citadel_Desk_Build wallholo = Citadel_Desk_Build.Cast( action_data.m_Target.GetObject() );

		ItemBase item = ItemBase.Cast( GetGame().CreateObjectEx( "Citadel_Desk_Manual", action_data.m_Player.GetPosition(), ECE_PLACE_ON_SURFACE ) );
