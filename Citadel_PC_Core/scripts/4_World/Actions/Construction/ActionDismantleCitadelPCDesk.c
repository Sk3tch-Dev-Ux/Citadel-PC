class ActionDismantleCitadel_DeskCB : ActionContinuousBaseCB
{
...
class ActionDismantleCitadel_Desk : ActionContinuousBase
{
    void ActionDismantleCitadel_Desk()
    {
        m_CallbackClass = ActionDismantleCitadel_DeskCB;
    ...
    override bool ActionCondition(PlayerBase player, ActionTarget target, ItemBase item)
    {
        ...
        Citadel_Desk desk = Citadel_Desk.Cast(target.GetObject());
    ...
    {
        Citadel_Desk desk = Citadel_Desk.Cast(action_data.m_Target.GetObject());
        ...
        ItemBase kit = ItemBase.Cast(GetGame().CreateObjectEx("Citadel_Desk_Manual", action_data.m_Player.GetPosition(), ECE_PLACE_ON_SURFACE));
    }
    ...
    void ReturnBuildingMaterials(Citadel_Desk desk)
    {
