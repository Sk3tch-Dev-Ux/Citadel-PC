modded class Citadel_Desk: BaseLaptop 
{
    ...
    const string	SOUND_DESK_BOOT 		= "Citadel_BOOT_SoundSet";
	const string	SOUND_DESK_SHUTDOWN 		= "Citadel_SHUTDOWN_SoundSet";
	const string	SOUND_DESK_FANS 		= "Citadel_FAN_SoundSet";
    ...
    protected const string MATERIAL_SCREENON = 		"Citadel_PC\\Models\\Core\\Monitor\\Textures\\monitor_on.rvmat";
	protected const string TEXTURE_SCREENON	=       "Citadel_PC\\Models\\Core\\Monitor\\Textures\\MonitorDESKTOP_co.paa";
	protected const string MATERIAL_SCREENOFF	= 	 "Citadel_PC\\Models\\Core\\Monitor\\Textures\\monitor_off.rvmat";
	protected const string TEXTURE_SCREENOFF	= 	"Citadel_PC\\Models\\Core\\Monitor\\Textures\\ScreenOFF_co.paa";
	protected const string TEXTURE_SCREENSHUTTINGDOWN	= 	"Citadel_PC\\Models\\Core\\Monitor\\Textures\\MonitorSHUTDOWN_co.paa";
    protected const string MATERIAL_KEYBOARDON = 		"Citadel_PC\\Models\\Core\\Keyboard\\Textures\\blueglow.rvmat";
	protected const string TEXTURE_KEYBOARDON	=   "Citadel_PC\\Models\\Core\\Keyboard\\Textures\\Key_Emissive.paa";
	protected const string MATERIAL_KEYBOARDOFF	= 	 "Citadel_PC\\Models\\Core\\Keyboard\\Textures\\glossy.rvmat";
	protected const string TEXTURE_KEYBOARDOFF	= 	"Citadel_PC\\Models\\Core\\Keyboard\\Textures\\Key_off.paa";
    protected const string MATERIAL_MOUSEON = 		"Citadel_PC\\Models\\Core\\Mouse\\Textures\\mouseblueglow.rvmat";
	protected const string TEXTURE_MOUSEON	=       "Citadel_PC\\Models\\Core\\Mouse\\Textures\\Mouse_lights_on.paa";
	protected const string MATERIAL_MOUSEOFF	= 	 "Citadel_PC\\Models\\Core\\Mouse\\Textures\\mouse.rvmat";
	protected const string TEXTURE_MOUSEOFF	= 	    "Citadel_PC\\Models\\Core\\Mouse\\Textures\\Mouse.paa";
    protected const string MATERIAL_COOLERON = 		"Citadel_PC\\Models\\Core\\PC\\Textures\\glow_on.rvmat";
	protected const string TEXTURE_COOLERON	=       "Citadel_PC\\Models\\Core\\PC\\Textures\\Cooler_And_Ram_Extra.paa";
	protected const string MATERIAL_COOLEROFF	= 	 "Citadel_PC\\Models\\Core\\Monitor\\Textures\\monitor_off.rvmat";
	protected const string TEXTURE_COOLEROFF	= 	"Citadel_PC\\Models\\Core\\PC\\Textures\\Cooler_And_Ram_Extra.paa";
    protected const string MATERIAL_MOTHERBOARDON = 		"Citadel_PC\\Models\\Core\\PC\\Textures\\glow_on.rvmat";
	protected const string TEXTURE_MOTHERBOARDON	=       "Citadel_PC\\Models\\Core\\PC\\Textures\\Board.paa";
	protected const string MATERIAL_MOTHERBOARDOFF	= 	 "Citadel_PC\\Models\\Core\\Keyboard\\Textures\\glossy.rvmat";
	protected const string TEXTURE_MOTHERBOARDOFF	= 	"Citadel_PC\\Models\\Core\\PC\\Textures\\Board.paa";
    protected const string MATERIAL_RAMON = 		"Citadel_PC\\Models\\Core\\PC\\Textures\\glow_on.rvmat";
	protected const string TEXTURE_RAMON	=       "Citadel_PC\\Models\\Core\\PC\\Textures\\Corsair_co.paa";
	protected const string MATERIAL_RAMOFF	= 	 "Citadel_PC\\Models\\Core\\PC\\Textures\\Corsair.rvmat";
	protected const string TEXTURE_RAMOFF	= 	"Citadel_PC\\Models\\Core\\PC\\Textures\\Corsair_lightsoff_co.paa";  
    
    protected const string MATERIAL_DESKON = 		"Citadel_PC\\Models\\Core\\PC\\Textures\\glow_on.rvmat";
	protected const string TEXTURE_DESKON	=       "Citadel_PC\\Models\\Core\\Desk\\Textures\\control.paa";
	protected const string MATERIAL_DESKOFF	= 	 "Citadel_PC\\Models\\Core\\Monitor\\Textures\\monitor_off.rvmat";
	protected const string TEXTURE_DESKOFF	= 	"Citadel_PC\\Models\\Core\\Desk\\Textures\\control_off.paa";

    protected const string MATERIAL_WIFI_ROUTERON = 		"Citadel_PC\\Models\\Core\\WiFi_Router\\Textures\\greenglow.rvmat";
	protected const string MATERIAL_WIFI_ROUTEROFF	= 	 "Citadel_PC\\Models\\Core\\WiFi_Router\\Textures\\WiFi.rvmat";
    protected const string MATERIAL_LOADINGON = 		"Citadel_PC\\Models\\Core\\Monitor\\Textures\\loadingscreen.rvmat";
	protected const string TEXTURE_LOADINGON	=       "Citadel_PC\\Models\\Core\\Monitor\\Textures\\loadingp22.paa";
	protected const string MATERIAL_LOADINGOFF	= 	 "Citadel_PC\\Models\\Core\\Monitor\\Textures\\monitor_on.rvmat";
	protected const string TEXTURE_LOADINGOFF	= 	"Citadel_PC\\Models\\Core\\Monitor\\Textures\\transparent.paa";
    protected const string TEXTURE_SHUTTINGOFF	= 	"Citadel_PC\\Models\\Core\\Monitor\\Textures\\MonitorSHUTDOWN_co.paa";
	protected const string TEXTURE_SHUTDOWNANIMON	=       "Citadel_PC\\Models\\Core\\Monitor\\Textures\\shuttingdown.paa";
	protected const string TEXTURE_SHUTDOWNANIMOFF	=       "Citadel_PC\\Models\\Core\\Monitor\\Textures\\transparent.paa";
    ...
    protected ref CitadelPcSettings m_Settings;


    string GetSOUND_DESK_BOOT()
    {
        return "Citadel_BOOT_SoundSet";
    }
    
    string GetSOUND_DESK_SHUTDOWN()
    {
        return "Citadel_SHUTDOWN_SoundSet";
    }
    
    string GetSOUND_DESK_FANS()
    {
        return "Citadel_FAN_SoundSet";
    }

    void Citadel_Desk()
    {
        m_Settings = CitadelPcSettings.Load();
    ...
    {
        Print("[Citadel_Desk Debug] " + message);
    }

	int GetTotalGraphicCardLifeTime()
	{
		int lifetime = 0;
        foreach(string slotName : g_CitadelPcGraphicCardSlots)
        {
	...
	int GetLifeTimeForGraphicCardAtSlot(string slotName)
    {
        ...
        if (!GetCitadelPcModule() || !GetCitadelPcModule().GetSettings())
            return 0;

        return GetCitadelPcModule().GetSettings().FindLifetimeForClassName(className);
    }
   ...
   void SetSmallFansAnimationPhase(float phase)
    ...
    override void OnWorkStart()
    {
        ...
        if (gpuCount < 1)
        {
            ...
            GetCitadelPcLogger().LogDebug("PC is not running due to insufficient graphic cards.");
        }
        else
        {
            GetCompEM().SwitchOn();
            DeskDebug("PC is ON.");
            GetCitadelPcLogger().LogDebug("PC is running.");
        }
    ...
    override void OnWork(float consumed_energy)
    {
        ...
        if (!GetGame().IsServer()) return;
        GetCitadelPcLogger().LogDebug("OnWork");
        ...
        GetCitadelPcLogger().LogDebug("lifetime:" + GetTotalGraphicCardLifeTime());
    ...
    override void OnWorkStop() 
    {
        ...
        if (!m_IsPCRunning) {
            ...
            GetCitadelPcLogger().LogDebug("OnWorkStop");
            lowerDesk();
        }
    ...
    {
        GetCitadelPcLogger().LogDebug("DecreaseAllGraphicCardQuantity:" + quantityToRemove);
    ...
    void DecreaseGraphicCardQuantityAtSlot(string slotName, float quantityToRemove)
    {
        ...
        GetCitadelPcLogger().LogDebug("new graphic card quantity :" + graphicCard.GetQuantity());
    }
    ...
    {
        foreach (string coinName, CitadelCoinSettings coinSettings : GetCitadelPcModule().GetSettings().coinSettings)
        {
    ...
    float GetGPUSpecificYield(CitadelCoinSettings coinSettings)
    {
    ...
    int GetGPUSpecificHashTime(CitadelCoinSettings coinSettings)
    {
        // Loop through the GPU types in the hashRates map to check if any is in use
        foreach (string gpuType, float _ : coinSettings.hashRates)
        {
    ...
    void ProcessMining(string coinName, string gpuType, float yield)
    {
        if (m_CoinMiningStatus.Contains(coinName) && m_CoinMiningStatus.Get(coinName))
        {
            ...
            CitadelCoinSettings coinSettings = GetCitadelPcModule().GetSettings().GetCoinSettings(coinName);
    ...
    void ScheduleNextMiningCycle(CitadelCoinSettings coinSettings, string gpuType)
    {
    ...
    void DamageGPUsAndPowerSupply(CitadelCoinSettings coinSettings)
    {
        // Damage the GPUs
        foreach (string slotName : g_CitadelPcGraphicCardSlots)
        {
    ...
    bool CheckForSufficientPowerAndGPUs(CitadelCoinSettings coinSettings) {
        foreach (string slotName : g_CitadelPcGraphicCardSlots) {
            ItemBase gpu = ItemBase.Cast(GetInventory().FindAttachmentByName(slotName));
    ...
    void IncrementCoin(string coinName, CitadelCoinSettings coinSettings, float yield)
    {
    ...
    {
		super.SetActions();
		AddAction(ActionTurnOffCitadelPC);
        AddAction( ActionTurnOnCitadelPC );
